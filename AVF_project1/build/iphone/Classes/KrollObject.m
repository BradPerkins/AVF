...
//@interface weather2Object : NSObject
//@end

@interface weather2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[weather2Object class]])
		{
			for (NSString *key in [[(weather2Object*)o modules] allKeys])
			{
