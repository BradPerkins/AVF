...
/**
 The base class for all weather2 modules
 */
...
/**
 weather2 Platform calls this method on startup.
 */
-(void)startup;

/**
 weather2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 weather2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 weather2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 weather2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
