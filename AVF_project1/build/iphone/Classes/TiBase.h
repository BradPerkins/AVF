...
// in simulator we redefine to format for weather2 Developer console
...
{\
	NSString * exceptionName = [@"org.weather2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.weather2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweather2NativeItemNone = -1, 
	UIweather2NativeItemSpinner = -2,
	UIweather2NativeItemProgressBar = -3,
	
	UIweather2NativeItemSlider = -4,
	UIweather2NativeItemSwitch = -5,
	UIweather2NativeItemMultiButton = -6,
	UIweather2NativeItemSegmented = -7,
	
	UIweather2NativeItemTextView = -8,
	UIweather2NativeItemTextField = -9,
	UIweather2NativeItemSearchBar = -10,
	
	UIweather2NativeItemPicker = -11,
	UIweather2NativeItemDatePicker = -12,
	
	UIweather2NativeItemInfoLight = -13,
	UIweather2NativeItemInfoDark = -14,
	
	UIweather2NativeItemDisclosure = -15,
	
	UIweather2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all weather2 instances of
